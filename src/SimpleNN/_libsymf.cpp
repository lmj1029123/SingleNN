...
/* 13 */ _CFFI_OP(_CFFI_OP_POINTER, 15), // double *
...
_cffi_f_calculate_sf(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    ...
    if (_cffi_convert_array_from_object((char *)x12, _cffi_type(13), arg12) < 0)
      return NULL;
  }
...
{
  return _cffi_init("_libsymf", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_libsymf(void)
{
  _cffi_init("_libsymf", 0x2601, &_cffi_type_context);
}
#endif
